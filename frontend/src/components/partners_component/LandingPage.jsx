  ...
  const testimonials = [
    {
      ...
      quote: 'Zomato enabled me to restart my operations post-COVID when I had no hope of doing my business again. I\'m grateful to the platform for helping me thrive - my online ordering business has done so well, it has even taken over my dining business!', // Replace with actual image path

    },
    {
      name: 'Vijay',
      title: 'Owner - Birgo, Coimbatore',
      quote: 'Thanks to Zomato\'s invaluable support, our startup cloud kitchen has been doing wonders in the competitive food industry landscape. Their dedication to promoting local businesses and powerful reporting tools have been instrumental in our success, and we look forward to a long-term partnership.',
    },
    {
      name: 'Sandeep K Mohan',
      title: 'Owner - Mysore Raman Idli, Kerala',
      quote : "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vero tempore officia esse laborum quaerat consectetur nemo ipsa fuga eveniet molestias vel reprehenderit consequatur debitis, perferendis, inventore magni enim sapiente rerum saepe, maxime et neque iste? Esse a accusamus iste"
    },
  ];
  ...
  return (
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="container mx-auto px-4 pt-28 w-full text-center">
        <h1 className="text-4xl font-bold text-black mb-4">Partner with GlamBook</h1>
        ...
        <div className="flex justify-center">
          <Link to={'/add-partner/step-1'} className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-4">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-16">
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-black">Attract new customers</h3>
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl text-black font-semibold">Doorstep delivery convenience</h3>
          <p className="text-md text-gray-600">
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl text-black font-semibold">Hotline support</h3>
          <p className="text-md text-gray-600">
      ...
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 text-black">Restaurant success stories</h2>
          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-800 italic min-h-36">"{testimonial.quote}"</p>
              </div>
            </div>
          ))}
        </div>
