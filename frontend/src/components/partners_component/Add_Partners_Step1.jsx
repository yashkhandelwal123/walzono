  ...
  return (
    <div className="bg-white min-h-screen w-full">
      ...
      <div className="flex pt-10">
        ...
        <div className="w-1/2">
            {/* parlour information */}
            <h2 className="text-3xl text-black font-bold mt-10">Parlour Information</h2>
            <form onSubmit={submitHandler}>

                {/* parlour name */}
                <div className="bg-white rounded-lg shadow-lg p-6 w-full mt-8 border border-gray-300">
                
                    <h2 className=" text-black text-2xl">Parlour Name</h2>
                    <span>Customers will see this name on GlamBook</span>
                    <input 
                        type="text"
                        className="w-full border border-gray-300 text-black bg-white rounded-lg p-2 mt-10"
                        value={parlourName}
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 w-full mt-8 border border-gray-300">
                    ...
                    <h2 className=" text-black text-2xl">Owner Details</h2>
                    <span>GlamBook will use these details for all business communications and updates</span>
                    ...
                    <div className="w-full flex items-center">
                        <span className="flex items-center mt-auto w-fit h-min border p-2 rounded-md">
                            <img 
                        ...
                        <input 
                            type="text" 
                            className="border ml-5 w-full border-gray-300 text-black bg-white rounded-lg p-2 mt-10"
                            value={phone}
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 w-full my-8 border border-gray-300">
                    ...
                    <h2 className=" text-black text-2xl">Parlour address details</h2>
                    <span>Address details are basis the parlour location mentioned above</span>
                    <span className="flex w-full">
                        <input 
                            type="text"
                            className="w-1/2 border mr-5 border-gray-300 text-black bg-white rounded-lg p-2 mt-10"
                    ...
                    <input 
                        type="text" 
                        className="border w-full border-gray-300 text-black bg-white rounded-lg p-2 mt-10"
        ...
        {/* <div className="py-3 flex justify-end shadow-2xl w-full">
            <button className="bg-green-600 text-white rounded-lg p-3 w-1/6 hover:bg-green-800 mr-20">Next</button>
        </div> */}
